        ...
        <div className="max-w-md mx-auto px-4 py-4">
          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-twine-900">🔍</span>
              <input
                type="text"
                placeholder="Search..."
                value={searchQuery}
            ...
            <button className="px-6 py-2.5 bg-twine-600 text-avocado-50 rounded-lg font-medium hover:bg-twine-500 transition-colors">
              Cari
            </button>
          </div>
        </div>
